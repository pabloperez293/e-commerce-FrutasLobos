...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[750px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200'>
      {/* fondo imagen */}
                ...
                <div className='order-1 sm:order-2 '>
                  <div className='relative z-10'>
                    <img
                      src={data.img}
                      alt=''
                      className='w-[300px] h-[300px] sm:h-[250px] sm:w-[250px] sm:scale-105 lg:scale-120 object-contain mx-auto '
                    />
                  </div>
                </div>
              </div>
